...
<div class="wrapper">
	...
	<?php include 'includes/navbar.php'; ?>
	  ...
	  <div class="content-wrapper"style="background: linear-gradient(to right, rgba(0, 0, 255, 0.6), rgba(255, 255, 255, 0.9));">
	    <div class="container" >
	        		...
	        		<div class="box" style="">
	        			<div class="box-header with-border">
	        				<div class="input-group">
				                <input type="text" class="form-control input-lg" id="searchBox" placeholder="Search for Books, Title or Author">
